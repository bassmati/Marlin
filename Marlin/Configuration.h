...
#define CUSTOM_MACHINE_NAME "CreatBot DX03"
...
#define PSU_NAME "PSU JHW360-24"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define POWER_TIMEOUT           200 // (s) Turn off power if the machine is idle for this duration
    //#define POWER_OFF_DELAY          60 // (s) Delay of poweroff after M81 command. Useful to let fans run for extra time.
  #endif
  #if ANY(AUTO_POWER_CONTROL, POWER_OFF_WAIT_FOR_COOLDOWN)
    #define AUTO_POWER_E_TEMP        65 // (°C) PSU on if any extruder is over this temperature
 ...
 */
#define TEMP_SENSOR_0 -1 // had to remove R17 - 4k7 pull-up for this to work
...
// Enable pullup for all endstops to prevent a floating state (10k pull-ups already on board for all 4 endstops)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78, 78, 800, 402 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 300, 8000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, -30, -0.85 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define X_BED_SIZE 260 // should be 300, dammit!
#define Y_BED_SIZE 220 // it's 250, but the new fan is chunky
...
#define Z_MAX_POS 285 // it can go to 295, but I'm not pushing it
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 3.0 // (mm) Default fade height: 10.0
  #endif
