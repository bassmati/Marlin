...
//
  ...
  #define BED_CHECK_INTERVAL 1500   // (ms) Interval between checks in bang-bang control
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PB15             // Override the default pin if needed
 ...
 */
  ...
  #define MANUAL_MOVE_DISTANCE_MM                       50, 10, 1  // (mm)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // home X/Y, move head away from endstops, move Z up a bit
  #define EVENT_GCODE_SD_ABORT "G28XY\nG1 X20 Y150\nG91\nG1 Z+30"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON1_PIN PD2                   // connected to PWR-CTRL circuit, "OUTPUT LOW Shutdown signal" pin
  #if PIN_EXISTS(BUTTON1)
    #define BUTTON1_HIT_STATE     LOW       // State of the triggered button. NC=LOW. NO=HIGH.
    #define BUTTON1_WHEN_PRINTING false     // Button allowed to trigger during printing?
    #define BUTTON1_GCODE         "M81"
    #define BUTTON1_DESC          "Power OFF"  // Optional string to set the LCD status
